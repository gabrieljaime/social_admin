@php
	...
	$deleteDialogSubTitle =  isset($dialogSubTitle) ? $dialogSubTitle :'';
@endphp
<dialog id="dialog_delete" class="mdl-dialog padding-0 @if(isset($isAjax) && $isAjax === true) ajax-dialog @endif" >
