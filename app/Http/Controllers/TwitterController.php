...
class TwitterController extends Controller
{
 ...
 /**
	...
	public function tweetsbysocial($social)
	{
		
		$tweets = TwitterSent::OfSocial($social)->orderBy('created_at','desc')->take(250)->get();

		$social= Social::find($social);

		$type = 'social';
		
		return view('twitter.tweets',compact('tweets', 'social','type'));
   ...
   public function status($id)
	 ...
	 public function showtype($id,$type)
	{
		...
		$friends=$friends->where('whitelist',false); 
